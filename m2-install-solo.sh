...
echo "=============================================="
echo "Magento 2 (dev) Installation for ONA Platform"
echo "=============================================="
...
# Configure Magento repository credentials (same as main installer)
...
# Clone Magento 2 (dev) repository and move into workspace root
echo "Cloning Magento 2 (dev) repository..."
rm -rf magento2 2>/dev/null || true

git clone https://github.com/magento/magento2.git && \
cd magento2 && cp -avr .* /workspaces/magento2gitpod

cd /workspaces/magento2gitpod && rm -rf magento2
...
echo ""
echo "=============================================="
echo "Magento 2 (dev) Installation Complete!"
echo "=============================================="
echo ""
